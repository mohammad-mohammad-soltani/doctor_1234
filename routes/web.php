...
Route::prefix('Manager')->group(function () {
    ...
    Route::middleware(\App\Http\Middleware\ManagerAuth::class)->group( function () {
        ...
        Route::get("/clinic/{id}" , [\App\Http\Controllers\Manager::class, "clinic_2"]) -> name("manager.clinic_2");
...
Route::prefix('Receptionist')->group(function () {
    ...
    Route::middleware(\App\Http\Middleware\OriginAuth::class)->group( function () {
        Route::get("/" , [\App\Http\Controllers\Manager::class, "panel"]) -> name("origin.dashboard");
